...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Main Content */}
      <main className="relative flex-grow px-8 py-24 md:py-32 md:px-12 lg:px-16 max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <section className="space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="group flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-300 transform hover:translate-y-[-2px] shadow-lg shadow-blue-500/20">
              ...
              <button className="group flex items-center justify-center gap-2 px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition-all duration-300 transform hover:translate-y-[-2px]">
