            ...
            <section className="space-y-10 animate-fade-in">
              ...
              <div className="space-y-6">
                ...
                <h1 className="text-5xl md:text-6xl font-bold text-gray-800 tracking-tight leading-tight">
                  Experience the <span className="text-blue-600">Philippines</span> like never before
                </h1>
            ...
            <section className="relative">
              ...
              <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-4">
                {experiences.map((exp, index) => (
                  <button
                    key={exp.id}
                    className={`experience-card p-6 text-left animate-fade-in w-full cursor-pointer
